...
const ITEMS = [
  ...
  {
    label: "販売形態",
    value: "完全受注生産（1点からご注文可能）\n在庫はお持ちしておらず、ご注文ごとに製作いたします。",
  },
  {
    label: "商品の引渡し時期",
    value: "仕上がりデザインをご確認・承認いただいた後、ご入金確認より14営業日以内に発送いたします。\n※受注生産のため、お届けまでお時間をいただきます。",
  },
  {
    label: "返品・交換について",
    value: "受注生産（お客様のペット写真を使ったオリジナル制作品）のため、お客様都合による返品・交換はお受けできません。\n商品の破損・品質不良・誤送等があった場合は、到着後7日以内にご連絡ください。\nご相談の上、交換または返金にて対応いたします。",
  },
  {
    label: "キャンセルについて",
    value: "仕上がりデザインのご承認前であれば、キャンセルを承ります。\nデザイン承認後・製作開始後のキャンセルはお受けできません（受注生産品のため）。",
  },
